...
![sample-decision-tree](../img/sample-decision-tree.png)
...
Let's get more specific. It's time to [Examine Your Data](../introduction-to-ml/basic-data-exploration.md).